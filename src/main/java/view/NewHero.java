...
// 		  Player.addElement("Spiderman");
// 		  Player.addElement("Blackpanther");
// 		  Player.addElement("Hulk");
// 		  Player.addElement("SuperMan");
// 		  Player.addElement("Badman");
...
// 			 hero = HeroFactory.createCharacter(name, type);
